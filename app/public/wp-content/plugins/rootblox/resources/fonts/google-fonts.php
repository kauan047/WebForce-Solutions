<?php
/**
 * Returns a list of Google Fonts available for use in blocks.
 *
 * This function provides an array of Google Font family names that are integrated
 * with the RootBlox theme's custom blocks. These fonts can be used in typography
 * controls within block settings, style panels, or editor previews.
 *
 * @since 1.0.0
 *
 * @return array List of Google Font family names as strings.
 */
function rootblox_google_fonts() {
	$fonts = array(
		'ABeeZee'                          => 'ABeeZee',
		'Abel'                             => 'Abel',
